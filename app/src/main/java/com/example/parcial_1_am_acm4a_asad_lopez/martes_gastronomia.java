...
public class martes_gastronomia extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titulos.add("Conocé las majoeres ofertas gastronomicas");
        titulos.add("Restaurantes tematicos");

        titulo_1=findViewById(R.id.titulo_1);
        titulo_1.setText(titulos.get(0));/*aca se agrega titulo resto*/
        titulo_2=findViewById(R.id.titulo_2);
        titulo_2.setText(titulos.get(1));/*aca se agrega titulo  resto2*/
